...
# ==================== CONFIGURATION ====================
BOT_TOKEN = "BOT_TOKEN"
ADMIN_ID = YOUR_TG_ID #get it from tg 
FORCE_CHANNEL = "YOUR_CHANNEL_USWRNAME" #link is look likes start from t.me/ of your channel so remove t.me/ and add (@) from that
